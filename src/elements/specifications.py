...
class Specifications(typing.NamedTuple):
    ...
    council_area: str
        ...
        of the hospital/institution; <a href="https://geoportal.statistics.gov.uk/documents/7ef19fb100de4c1ab964f65599e9534b/explore"
        target="_blank">map</a>.<br>
    intermediate_zone: str
        <a href="https://geoportal.statistics.gov.uk/datasets/ons::intermediate-zones-december-2001-names-and-codes-in-sc/about"
        target="_blank">Intermediate Zone</a><br>
    data_zone: str
        <a href="https://geoportal.statistics.gov.uk/datasets/ons::data-zones-december-2011-names-and-codes-in-sc/about">Data Zones</a>
    """
